...
namespace DittoMod.Modules.Survivors
{
    ...
    internal class Ditto : SurvivorBase
    {
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            armorGrowth = 0.5f,
            bodyName = "DittoBody",
            bodyNameToken = DittoPlugin.developerPrefix + "_DITTO_BODY_NAME",
            ...
            maxHealth = 100f,
            moveSpeed = 7f,
            subtitleNameToken = DittoPlugin.developerPrefix + "_DITTO_BODY_SUBTITLE",
            podPrefab = RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod")
        };

        internal static Material dittoMat = Modules.Assets.CreateMaterial("DittoMat");
