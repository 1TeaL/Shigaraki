...
namespace DittoMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = DittoPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = DittoPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = DittoPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = DittoPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            DittoPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            DittoPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            DittoPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
        ...
        internal static void SetupCharacterModel(GameObject prefab, CustomRendererInfo[] rendererInfo, int mainRendererIndex)
        {
            ...
            characterModel.body.overrideCoreTransform = childLocator.FindChild("Spine");
            characterModel.body.coreTransform = childLocator.FindChild("Spine");
