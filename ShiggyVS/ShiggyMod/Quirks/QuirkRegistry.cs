...
namespace ShiggyMod.Modules.Quirks
{
    ...
    public static class QuirkTargetingMap
    {
        ...
        public static void BuildBodyToQuirkId()
        {
            ...
            // Passives (L1)
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_MajorAndMinorConstruct.MinorConstructBody_prefab).WaitForCompletion().name, QuirkId.AlphaConstruct_BarrierPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_MajorAndMinorConstruct.MinorConstructOnKillBody_prefab).WaitForCompletion().name, QuirkId.AlphaConstruct_BarrierPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_MajorAndMinorConstruct.MinorConstructAttachableBody_prefab).WaitForCompletion().name, QuirkId.AlphaConstruct_BarrierPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Beetle.BeetleBody_prefab).WaitForCompletion().name, QuirkId.Beetle_StrengthPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_FlyingVermin.FlyingVerminBody_prefab).WaitForCompletion().name, QuirkId.Pest_JumpPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_Vermin.VerminBody_prefab).WaitForCompletion().name, QuirkId.Vermin_SpeedPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_Gup.GupBody_prefab).WaitForCompletion().name, QuirkId.Gup_SpikyBodyPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_Gup.GipBody_prefab).WaitForCompletion().name, QuirkId.Gup_SpikyBodyPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_Gup.GeepBody_prefab).WaitForCompletion().name, QuirkId.Gup_SpikyBodyPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_HermitCrab.HermitCrabBody_prefab).WaitForCompletion().name, QuirkId.HermitCrab_MortarPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_AcidLarva.AcidLarvaBody_prefab).WaitForCompletion().name, QuirkId.Larva_AcidJumpPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Wisp.WispBody_prefab).WaitForCompletion().name, QuirkId.LesserWisp_HastePassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_LunarExploder.LunarExploderBody_prefab).WaitForCompletion().name, QuirkId.LunarExploder_LunarBarrierPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_MiniMushroom.MiniMushroomBody_prefab).WaitForCompletion().name, QuirkId.MiniMushrum_HealingAuraPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_RoboBallBoss.RoboBallMiniBody_prefab).WaitForCompletion().name, QuirkId.RoboBallMini_SolusBoostPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_RoboBallBuddy.RoboBallGreenBuddyBody_prefab).WaitForCompletion().name, QuirkId.RoboBallMini_SolusBoostPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_RoboBallBuddy.RoboBallRedBuddyBody_prefab).WaitForCompletion().name, QuirkId.RoboBallMini_SolusBoostPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_VoidBarnacle.VoidBarnacleBody_prefab).WaitForCompletion().name, QuirkId.VoidBarnacle_VoidMortarPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_VoidJailer.VoidJailerBody_prefab).WaitForCompletion().name, QuirkId.VoidJailer_GravityPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_ImpBoss.ImpBossBody_prefab).WaitForCompletion().name, QuirkId.ImpBoss_BleedPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Titan.TitanBody_prefab).WaitForCompletion().name, QuirkId.StoneTitan_StoneSkinPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Titan.TitanGoldBody_prefab).WaitForCompletion().name, QuirkId.StoneTitan_StoneSkinPassive);
            ...
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Croco.CrocoBody_prefab).WaitForCompletion().name, QuirkId.Acrid_PoisonPassive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Loader.LoaderBody_prefab).WaitForCompletion().name, QuirkId.Loader_ScrapBarrierPassive);

            // Actives (L1)
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Vulture.VultureBody_prefab).WaitForCompletion().name, QuirkId.Vulture_WindBlastActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_BeetleGuard.BeetleGuardBody_prefab).WaitForCompletion().name, QuirkId.BeetleGuard_SlamActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Bison.BisonBody_prefab).WaitForCompletion().name, QuirkId.Bison_ChargeActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Bell.BellBody_prefab).WaitForCompletion().name, QuirkId.Bell_SpikedBallActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_ClayGrenadier.ClayGrenadierBody_prefab).WaitForCompletion().name, QuirkId.ClayApothecary_MortarActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_ClayBruiser.ClayBruiserBody_prefab).WaitForCompletion().name, QuirkId.ClayTemplar_MinigunActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_LemurianBruiser.LemurianBruiserBody_prefab).WaitForCompletion().name, QuirkId.ElderLemurian_FireBlastActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_GreaterWisp.GreaterWispBody_prefab).WaitForCompletion().name, QuirkId.GreaterWisp_SpiritBoostActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Imp.ImpBody_prefab).WaitForCompletion().name, QuirkId.Imp_BlinkActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Jellyfish.JellyfishBody_prefab).WaitForCompletion().name, QuirkId.Jellyfish_HealActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Lemurian.LemurianBody_prefab).WaitForCompletion().name, QuirkId.Lemurian_FireballActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_LunarGolem.LunarGolemBody_prefab).WaitForCompletion().name, QuirkId.LunarGolem_SlideResetActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_LunarWisp.LunarWispBody_prefab).WaitForCompletion().name, QuirkId.LunarWisp_MinigunActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Parent.ParentBody_prefab).WaitForCompletion().name, QuirkId.Parent_TeleportActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Golem.GolemBody_prefab).WaitForCompletion().name, QuirkId.StoneGolem_LaserActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Nullifier.NullifierBody_prefab).WaitForCompletion().name, QuirkId.VoidReaver_PortalActive);

            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_BeetleQueen.BeetleQueen2Body_prefab).WaitForCompletion().name, QuirkId.BeetleQueen_SummonActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Gravekeeper.GravekeeperBody_prefab).WaitForCompletion().name, QuirkId.Grovetender_ChainActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_ClayBoss.ClayBossBody_prefab).WaitForCompletion().name, QuirkId.ClayDunestrider_TarBoostActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Grandparent.GrandParentBody_prefab).WaitForCompletion().name, QuirkId.Grandparent_SunActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_RoboBallBoss.RoboBallBossBody_prefab).WaitForCompletion().name, QuirkId.SolusControlUnit_KnockupActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_RoboBallBoss.SuperRoboBallBossBody_prefab).WaitForCompletion().name, QuirkId.SolusControlUnit_KnockupActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_MajorAndMinorConstruct.MegaConstructBody_prefab).WaitForCompletion().name, QuirkId.XIConstruct_BeamActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_MajorAndMinorConstruct.MajorConstructBody_prefab).WaitForCompletion().name, QuirkId.XIConstruct_BeamActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_VoidMegaCrab.VoidMegaCrabAllyBody_prefab).WaitForCompletion().name, QuirkId.VoidDevastator_MissilesActive);

            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Bandit2.Bandit2Body_prefab).WaitForCompletion().name, QuirkId.Bandit_LightsOutActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Engi.EngiBody_prefab).WaitForCompletion().name, QuirkId.Engineer_TurretActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Huntress.HuntressBody_prefab).WaitForCompletion().name, QuirkId.Huntress_FlurryActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Mage.MageBody_prefab).WaitForCompletion().name, QuirkId.Artificer_FlamethrowerActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Merc.MercBody_prefab).WaitForCompletion().name, QuirkId.Merc_DashActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Toolbot.ToolbotBody_prefab).WaitForCompletion().name, QuirkId.MULT_PowerStanceActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Treebot.TreebotBody_prefab).WaitForCompletion().name, QuirkId.REX_MortarActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_Railgunner.RailgunnerBody_prefab).WaitForCompletion().name, QuirkId.Railgunner_CryoActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_DLC1_VoidSurvivor.VoidSurvivorBody_prefab).WaitForCompletion().name, QuirkId.VoidFiend_CleanseActive);
            QuirkTargetingMap.Add(Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPaths.RoR2_Base_Shopkeeper.ShopkeeperBody_prefab).WaitForCompletion().name, QuirkId.Deku_OFAActive);
