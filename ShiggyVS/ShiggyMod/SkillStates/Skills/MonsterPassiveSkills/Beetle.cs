...
{
    public class Beetle : BaseSkillState
    {
        ...
        private void StealQuirk(HurtBox hurtBox)
        {
            ...
            if (base.IsKeyDownAuthority() && extrainputBankTest.extraSkill1.down)
            {
                ...
                if (newbodyPrefab.name == "BeetleBody")
                {
                    ...
                    extraskillLocator.extraSecond.UnsetSkillOverride(extraskillLocator.extraFirst, Shiggy.beetlepassiveDef, GenericSkill.SkillOverridePriority.Contextual);
