    ...
    public class Transform : BaseSkillState
    {
        ...
        private void ChangeOrSetCharacter(NetworkUser player, HurtBox hurtBox)
        {
            ...
            if (!blacklist.Contains(newbodyPrefab.name))
            {
                ...
                {
                    Shiggymastercon.transformed = true;
                ...
                if (hurtBox.healthComponent.body.HasBuff(ShiggyMod.Modules.Assets.mendingelitebuff))
                {
                    body.AddBuff(ShiggyMod.Modules.Assets.mendingelitebuff);
                }
                if (hurtBox.healthComponent.body.HasBuff(ShiggyMod.Modules.Assets.voidelitebuff))
                {
                    body.AddBuff(ShiggyMod.Modules.Assets.voidelitebuff);
                }
            ...
            else
            {
                ...
                Chat.AddMessage("Shiggy's <style=cIsUtility>Transform failed!</style>");
            }
