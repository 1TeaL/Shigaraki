    ...
    public class AlloyVultureWindBlast : Skill
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if(base.fixedAge > firetime && !hasFired)
            {
                ...
                new PerformForceNetworkRequest(characterBody.masterObjectId, base.GetAimRay().origin - GetAimRay().direction, base.GetAimRay().direction, pushRange).Send(NetworkDestination.Clients);
            }
