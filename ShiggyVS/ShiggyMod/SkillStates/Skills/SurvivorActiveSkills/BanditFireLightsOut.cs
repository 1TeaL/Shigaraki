...
namespace ShiggyMod.SkillStates
{
    public class BanditFireLightsOut : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            {
                damageType |= DamageType.BleedOnHit | DamageType.BonusToLowHealth | DamageType.ResetCooldownsOnKill;
            }
            if (base.HasBuff(Modules.Buffs.acridBuff))
            {
                damageType |= DamageType.PoisonOnHit | DamageType.BonusToLowHealth | DamageType.ResetCooldownsOnKill;
            }
