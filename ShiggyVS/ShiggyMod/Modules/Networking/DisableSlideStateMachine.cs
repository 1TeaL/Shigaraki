...
{
    internal class DisableSlideStateMachine : INetMessage
    {
        NetworkInstanceId netID;

        public DisableSlideStateMachine()
        {

        }

        public DisableSlideStateMachine(NetworkInstanceId netID)
        {
            this.netID = netID;
        }
        ...
        public void ForceGoBeyondState()
        {
            ...
            foreach (EntityStateMachine stateMachine in stateMachines)
            {
                ...
                {
                    stateMachine.SetState(new Skill());
                    return;
                }
            }
        }
