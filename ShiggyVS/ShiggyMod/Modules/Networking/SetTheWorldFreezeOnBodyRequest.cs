...
{
    internal class SetTheWorldFreezeOnBodyRequest : INetMessage
    {
        NetworkInstanceId netID;

        public SetTheWorldFreezeOnBodyRequest()
        {

        }

        public SetTheWorldFreezeOnBodyRequest(NetworkInstanceId netID)
        {
            this.netID = netID;
        }
