...
{
    internal class LightAndDarknessPullRequest : INetMessage
    {
        //Network these ones.
        ...
        public LightAndDarknessPullRequest()
        {

        }

        public LightAndDarknessPullRequest(NetworkInstanceId netID, Vector3 origin, Vector3 direction, float searchRange, float pullRange, float damage, float angle, bool playEffect)
        {
            this.netID = netID;
            this.origin = origin;
