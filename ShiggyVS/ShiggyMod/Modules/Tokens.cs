    ...
    internal static class Tokens
    {
        internal static void AddTokens()
        {
            ...
            LanguageAPI.Add(prefix + "AFO_DESCRIPTION", $"Steal the Target's quirk. Steal the elite aspect as well. " +
                "Actives<style=cWorldEvent>[Circle]</style> replace main skills and Passives<style=cWorldEvent>[Triangle]</style> replace extra skills. " + Environment.NewLine +
                "Hold the button for 3 seconds to remove quirks. " + Environment.NewLine + 
            ...
            LanguageAPI.Add(prefix + "MULTBUFFCANCEL_DESCRIPTION", $"<style=cIsDamage> Agile.</style> Cancel the stance. " +
