...
namespace ShiggyMod.Modules
{
    public static class Buffs
    {
        ...
        {
            //passive buffs
            beetleBuff = Buffs.AddNewBuff($"Strength Buff- <style=cIsDamage>Gain {Modules.Config.StrengthBoostBaseDamage} base damage</style>. ", ShiggyAsset.boostBuffIcon, new Color(0.67f, 0.87f, 0.93f), false, false);
            ...
            lesserwispBuff = Buffs.AddNewBuff($"Haste Buff- <style=cIsDamage>Gain {Modules.Config.HasteAttackSpeedAdditive.Value} flat attackspeed</style>.", ShiggyAsset.boostBuffIcon, Color.red, false, false);
            ...
            stonetitanBuff = Buffs.AddNewBuff($"Stone Skin Buff- <style=cIsUtility>Gain {Modules.Config.StoneSkinArmorGain.Value} armor and flat damage reduction equal to your armor</style>. " +
            ...
            commandoBuff = Buffs.AddNewBuff($"Double Tap Buff- All attacks hit twice, dealing <style=cIsDamage>{100 * Modules.Config.DoubleTapDamage.Value}% damage</style> of the attack, with a proc coefficient of {Modules.Config.DoubleTapProc.Value}.", ShiggyAsset.critBuffIcon, Color.magenta, false, false);
            ...
            loaderBuff = Buffs.AddNewBuff($"Scrap Barrier Buff- Gain <style=cIsUtility> Gain {100f * Modules.Config.ScrapBarrierBarrierGain.Value} of your max health as barrier</style> on all attacks.", ShiggyAsset.shieldBuffIcon, Color.yellow, false, false);
            ...
            falsesonStolenInheritanceBuff = Buffs.AddNewBuff($"Stolen Inheritance Buff- Gain bonus base damage equal to {Modules.Config.StolenInheritanceHPCoefficient.Value * 100f}% of maximum health.", ShiggyAsset.falseSonEnergizedCoreBuffIcon, new Color(235f, 150f, 50f), false, false);
